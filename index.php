...
error_reporting(E_ERROR | E_PARSE);
 ...
 ?>
 <meta http-equiv = "refresh" content = "0; url = http://localhost/demolan/dispay1.php"/>
 <?php
 }
 ...
 ?>
 <meta http-equiv = "refresh" content = "0; url = http://localhost/demolan/display2.php"/>
 <?php
 }
 ...
 ?>
 <meta http-equiv = "refresh" content = "0; url = http://localhost/demolan/display3.php"/>
 <?php
 }
 ...
 ?>
 <meta http-equiv = "refresh" content = "0; url = http://localhost/demolan/dashboaed.php?use=$username"/>
 <?php
 }
 $query4="SELECT * FROM admin WHERE usename='$username' && password='$pwd' ";
 $data4=mysqli_query($conn,$query4);
 $total4=mysqli_num_rows($data4);
 if($total4){
 
 ?>
 <meta http-equiv = "refresh" content = "0; url = http://localhost/demolan/display4.php"/>
 <?php
 }
 $query1="SELECT * FROM checkhistory WHERE authority='$username' && password='$pwd' ";
 $data1=mysqli_query($conn,$query1);
 $total5=mysqli_num_rows($data1);

 if($total5){

 ?>
 <meta http-equiv = "refresh" content = "0; url = http://localhost/demolan/history.php"/>
 <?php
 }
//  elseif($total==0 && $total1==0 && $total2==0 && $total4==0 && $total5==0){
//     echo "<script>alert('Input fields does not match');</script>";
//  }
 } 
 ?>